			...
			<div className="container relative">
				...
				<div className="row g-5 mb-5">
					<div className="col-lg-4">
						<div className="mb-4 footer-logo-wrap"><a href="#" class="footer-logo">Furni<span>.</span></a></div>
				...
				<div className="border-top copyright">
					<div className="row pt-4">
						...
						<div className="col-lg-6">
							...
							Copyright &copy;. All Rights Reserved. &mdash; Designed with love by <a href="https://untree.co">Untree.co</a> 
