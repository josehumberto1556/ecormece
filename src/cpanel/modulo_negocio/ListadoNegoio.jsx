...
function ListadoNegocio() {
  ...
  },
  {
	name:"Modificar",
	cell:(row)=><Link 
	to={`/ModuloAdministrador/modulo_negocio/EditarNegocio/${row.id}`} 
  ...
  useEffect( () => {
    ...
    const result=empre.filter((country)=>{
	  return country.nombre_negocio.substring(0, 20).toLowerCase().match(search.toLowerCase())
	})
		  ...
		  <div className="row">
		    <div className="col-lg-12 grid-margin stretch-card">
			  <div className="card">
				...
				<h4 className="card-title">Listado de Negocios</h4>
				<DataTable 
				columns={columns} 
				...
				actions={<Link to="/ModuloAdministrador/modulo_negocio/RegistraNegocio" 
